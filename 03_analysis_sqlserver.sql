...
执行方式：可在SSMS中选中单条查询单独执行，也可以一次性全部执行
*/
PRINT '========== 开始执行业务指标分析 =========='
GO

-- ============================================================
-- 指标1：全部已交付订单总销售额（商品金额+运费）
-- ============================================================
...
-- ============================================================
-- 指标4：用户复购统计
-- 重点：使用customer_unique_id(真实用户ID)，不要用customer_id
--       customer_id是订单维度ID，每个订单不一样
-- ============================================================
...
-- ============================================================
-- 指标6：商品品类销售排行；关联翻译表，把葡萄牙语品类转为英文便于阅读
-- ============================================================
